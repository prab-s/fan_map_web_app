    ...
    for product in products:
        ...
        series_entry = series_map.setdefault(
            series_key_text,
            {
                ...
                "first_product_preview_image_url": None,
            },
        )
        ...
        if not series_entry.get("first_product_preview_image_url"):
            series_entry["first_product_preview_image_url"] = (
                product.get("public_primary_product_image_url")
                or product.get("primary_product_image_url")
                or product.get("graph_image_url")
            )

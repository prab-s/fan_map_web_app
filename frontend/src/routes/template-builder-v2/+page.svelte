<script>
  ...
  function buildPreviewTokenMap() {
    ...
    return {
      ...
      '{{product.description5_html}}': '<p>Sample product description 5.</p>',
      '{{product.description6_html}}': '<p>Sample product description 6.</p>',
      '{{product.description7_html}}': '<p>Sample product description 7.</p>',
      '{{product.description8_html}}': '<p>Sample product description 8.</p>',
      '{{product.description9_html}}': '<p>Sample product description 9.</p>',
      '{{product.description10_html}}': '<p>Sample product description 10.</p>',
      '{{product.description_sections_html}}': '<p>All non-empty product description blocks appear here in order.</p><p>Additional description content appears directly after the previous block.</p>',
      ...
      '{{series.description5_html}}': '<p>Sample series description 5.</p>',
      '{{series.description6_html}}': '<p>Sample series description 6.</p>',
      '{{series.description7_html}}': '<p>Sample series description 7.</p>',
      '{{series.description8_html}}': '<p>Sample series description 8.</p>',
      '{{series.description9_html}}': '<p>Sample series description 9.</p>',
      '{{series.description10_html}}': '<p>Sample series description 10.</p>',
      '{{series.description_sections_html}}': '<p>All non-empty series description blocks appear here in order.</p><p>Additional description content appears directly after the previous block.</p>',
